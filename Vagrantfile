...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    aws.security_groups = ['sg-4248a82d']
    aws.tags = {
      'Name' => 'VagrantTest',
    ...
    override.ssh.private_key_path = "ec2-apache01.pem"
  ...
  #config.proxy.no_proxy = "localhost,127.0.0.1,.skygroup.local,localnet.sts.co.jp,192.168..,10...,1.1.1.1"
end
